...
📱 Works on iOS (LiDAR) and Android (photogrammetry)<br><br>
✨ Supports **Gaussian splatting** for high-quality rendering<br><br>
📤 Export to multiple 3D file formats<br><br>
🕶️ AR and VR integration capabilities<br><br>
